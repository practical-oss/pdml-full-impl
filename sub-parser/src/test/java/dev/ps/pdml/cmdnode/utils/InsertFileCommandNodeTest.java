...
class InsertFileCommandNodeTest {
    ...
    void handleNode() throws IOException, PdmlException {
        ...
        TextFileWriterUtil.writeStringToUTF8File (
            "[root ^[ins-file   sub_dir/file_to_insert.txt  ]]", pdmlFile, false );
        ...
        TextFileWriterUtil.writeStringToUTF8File (
            "[root ^[ins-file [path sub_dir/file_to_insert.txt]]]", pdmlFile, false );
        ...
        // [path sub_dir/file_to_insert.txt] [escape-text yes]
        TextFileWriterUtil.writeStringToUTF8File (
            "[root ^[ins-file [path sub_dir/file_to_insert.txt] [escape-text yes]]]", pdmlFile, false );
        TextFileWriterUtil.writeStringToUTF8File (
            "file [content]", fileToInsert, true );
        rootNode = ParseASTUtil.parseFile ( pdmlFile );
        assertEquals ( "file [content]", rootNode.toText() );

        // sub_dir/file_to_insert.txt [escape-text yes]
        TextFileWriterUtil.writeStringToUTF8File (
            "[root ^[ins-file sub_dir/file_to_insert.txt [escape-text yes]]]", pdmlFile, false );
        TextFileWriterUtil.writeStringToUTF8File (
            "file [content]", fileToInsert, true );
        rootNode = ParseASTUtil.parseFile ( pdmlFile );
        assertEquals ( "file [content]", rootNode.toText() );

        // [escape-text yes] sub_dir/file_to_insert.txt
/*
        TextFileWriterUtil.writeStringToUTF8File (
            "[root ^[ins-file [escape-text yes] sub_dir/file_to_insert.txt]]", pdmlFile, false );
        TextFileWriterUtil.writeStringToUTF8File (
            "file [content]", fileToInsert, true );
        rootNode = ParseASTUtil.parseFile ( pdmlFile );
        assertEquals ( "file [content]", rootNode.toText() );
 */
        ...
        TextFileWriterUtil.writeStringToUTF8File (
            "[root ^[ins-file inexistent_file.txt [default foo]]]", pdmlFile, false );
        TextFileWriterUtil.writeStringToUTF8File (
            "file [content]", fileToInsert, true );
        rootNode = ParseASTUtil.parseFile ( pdmlFile );
        ...
        TextFileWriterUtil.writeStringToUTF8File (
            "[root ^[ins-file inexistent_file.txt]", pdmlFile, false );

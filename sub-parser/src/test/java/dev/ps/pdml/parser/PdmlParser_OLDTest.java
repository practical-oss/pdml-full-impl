...
class PdmlParser_OLDTest {

/*
    @Test
    void requireRootNode() throws IOException, PdmlException {

        PdmlParser_OLD parser = createParser ( "\r\n\t [root]\n" );
    ...
    void parseTag () throws IOException, PdmlException {
        ...
        PdmlParser_OLD parser = createParser ( "tag]" );
    ...
    private void checkStringLiteral ( String pdmlCode, String expected ) throws IOException, PdmlException {
        ...
        PdmlParser_OLD parser = createParser ( pdmlCode );
    ...
    private @NotNull PdmlParser_OLD createParser ( @NotNull String code ) throws IOException {
        StringReader stringReader = new StringReader ( code );
        return PdmlParser_OLD.create ( stringReader, new StringReaderResource ( code ), PdmlParserConfig.defaultConfig() );
    }
 */
}
